...
# Declaration of work
* For Assignment 1, Hugo did all programming and analysis, with some help from Marijn.

* For Assignment 2, Marijn did all the programming and analysis.

* For Assignment 3, Simon did all the programming and analysis.
...
$$z = \theta^T \boldsymbol{x} = (\theta_0, \theta_1, \theta_2) \cdot (1, x_{\text{pgc}}, x_{\text{age}})^T.$$

The decision boundary for this model will be the set of points that satisfy the following equation:

$$g(\boldsymbol{x}) = \frac{e^{\theta^T \boldsymbol{x}}}{1+e^{\theta^T \boldsymbol{x}}} = \frac{1}{2} \implies \theta^T \boldsymbol{x} = 0 \implies \theta_0 + \theta_1 \cdot x_1 + \theta_2 \cdot x_2 = 0 \implies x_2 = \frac{-\theta_0}{\theta_2} - \frac{\theta_1}{\theta_2} x_1.$$
