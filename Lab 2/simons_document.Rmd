...
X_crime_approx <- Z_crime_2 %*% solve(U_crime$vectors[,c(1,2)]) + scaler$mean

variance_crime_PC12 <- X_crime - Z_crime_2


# Check if the inverse of U_crime is the same as the transpose
#all.equal(t(U_crime$vectors), solve(U_crime$vectors))
```
