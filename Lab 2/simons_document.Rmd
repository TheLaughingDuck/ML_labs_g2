...
## Assignment 3.3
Now we wish to attempt to construct a linear prediction model. First we split the available data into train and test groups (50/50). The Mean Squared Error for train and test data is reported below. There is a significant jump from the train to the test error, which indicates that the model might be overfitting the data.
...
# Old iterating for Assignment 3.4
```{r}
# Iterate and stuff
# theta <- rep(0, 100)
# train_errors <- c()
